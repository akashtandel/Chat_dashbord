			...
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" method="post">
					...
					<!--<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" name="loginemail" placeholder="User name">
					...
					<div class="container-login100-form-btn m-t-32">
						<button class="login100-form-btn" name="login_sub">
							Login
						</button>
					</div>-->
					
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input type="text" name="name" placeholder="Enter username" class="input100" />
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>
					...
					This is a success alert—check it out!
							...
							<!--<a href="userforgot_pass.php">Forgot password</a>-->
...
if(isset($_POST['login_sub']))
{
	...
	$pass = $_POST['loginpassword'];
		...
		$sql = mysqli_query($con,"select * from table_user where user_name='$name' and user_pass='$pass'");
